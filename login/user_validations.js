...
function setError(input, message) {
    ...
    if (small) {
        ...
        console.error("Error message element not found for:", input);
    }
}
...
async function Login() {
    ...
    try {
        ...
        if (response.ok && body.token) {
            ...
            let authorized = await checking(); // checking role.................................


            if (authorized) {
                alert("Login Successful!");
                window.location.href = "/user/dashboard.html"; // Redirects to correct dashboard path
            } else {
